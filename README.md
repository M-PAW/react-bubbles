...
- [ ] Explain what a token is used for.
  ...
  It is used for authentication. (weak)

- [ ] What steps can you take in your web apps to keep your data secure?

  use secure routes, use authentication, ecryption, strong password policy

- [ ] Describe how web servers work.

  As either sofware, hardware, or both. They serve up applications or webpages.
